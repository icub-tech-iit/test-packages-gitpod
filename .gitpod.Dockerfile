...
ARG ICUB_COMMON_PKG=https://github.com/robotology/icub-main/releases/download/v1.20.0/icub-common_1.20.0-1.focal_amd64.deb
ARG YARP_PKG=https://github.com/robotology/yarp/releases/download/v3.4.0/yarp-3.4.0-2.focal_amd64.deb
ARG ICUB_PKG=https://github.com/robotology/icub-main/releases/download/v1.20.0/iCub1.20.0-1.focal_amd64.deb
